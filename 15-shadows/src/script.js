...
directionalLightCameraHelper.visible = debug;
...
spotLightCameraHelper.visible = debug;
...
pointLightCameraHelper.visible = debug;
...
const tick = () => {
  ...
  const scale = 1 - sphere.position.y;
  const opacity = (1 - sphere.position.y) * 0.9;
  sphereShadow.scale.set(scale, scale);
  sphereShadow.material.opacity = opacity;
